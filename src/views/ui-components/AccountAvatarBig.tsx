...
export function AccountAvatarBig(props: any) {
    ...
    return (
        <>
            <div className={`${props.add ? "bg-slate-100" : props.name.toColor()} flex max-w-sm p-6 border border-gray-200 rounded-lg shadow-sm w-25 h-25 items-center justify-center`}>
